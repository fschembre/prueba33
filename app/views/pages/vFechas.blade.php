            ...
            <ul id='tabs' class='nav nav-tabs' data-tabs='tabs'>
             ...
             <div id="my-tab-content" class="tab-content">                  
              <div class="tab-pane active" id="resumen">                        
                  <p>{{ vFecha::MakeResumenGrid('resumen', $desde, $hasta); }} </p>  
              </div>
               <div class="tab-pane" id="loteria">                        
                  <p>{{ vFecha::MakeGrid('vloteria', $desde, $hasta); }} </p>  
              </div>
              <div class="tab-pane" id="parley">                        
                  <p>{{ vFecha::MakeGrid('vparley', $desde, $hasta); }} </p>  
              </div>
              <div class="tab-pane" id="preimpresos">                        
                  <p>{{ vFecha::MakeGrid('vpreimpreso', $desde, $hasta); }} </p>  
              </div>
              <div class="tab-pane" id="copias">                        
                  <p>{{ vFecha::MakeGrid('vcopia', $desde, $hasta); }} </p>  
              </div>          
          </div>
